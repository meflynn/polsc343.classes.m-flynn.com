...
dfr$comment[dfr$date==as.Date("2024-11-08")] <- "Helberg Discussion"
dfr$comment[dfr$date==as.Date("2024-11-22")] <- "Busby Discussion"
...
## `r advdate(mon, 14)`: Environmental Politics and US Foreign Policy
...
## `r advdate(mon, 16)`: Human Rights Issues
