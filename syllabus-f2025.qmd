...
## `r advdate(mon, 9)`: Bureaucracies, State Department, and Department of Defense, Cont.
...
## `r advdate(mon, 10)`: The Use of Military Force
...
## `r advdate(mon, 11)`: Security Cooperation
...
## `r advdate(mon, 12)`: Trade, Finance, and Monetary Policy
...
## `r advdate(mon, 13)`: Trade, Finance, and Monetary Policy (cont.)
