...
:::{.column}
```{r confounding-car-1, fig.pos="center", out.height="5in", out.width="9in"}
...
:::{.column}
```{r confounding-car-2, fig.pos="center", out.height="5in", out.width="9in"}
...
#table(baserate$Group, baserate$Hospitalized)
...
```{r base-rate-fallacy-2}

#prop.table(table(baserate$Group, baserate$Hospitalized))
...
:::{.column}
```{r simpsons-paradox-1, out.width = "6in", out.height="4.5in", fig.pos="center", dpi=400}
#|echo: false
...
:::{.column}
```{r simpsons-paradox-2, out.width = "6in", out.height="4.5in", fig.pos="center", dpi=400}
#|echo: false
...
:::{.column}
```{r collider-example-plot-1, out.width = "6in", out.height="4.5in", fig.pos="center", dpi=400}
#|echo: false
#|dpi: 300
#|width: 50%
...
:::{.column}
```{r collider-example-plot-2, out.width = "6in", out.height="4.5in", fig.pos="center", dpi=400}
#|echo: false
#|dpi: 300
#|width: 50%
...
- More accurately, theory is the story we tell about how variables are related. It both describes and explains how variables affect one another. 

- It also allowsus to make predictions about what we sould expect to see in various scenarios

> **Theory:** A tentative conjecture about the causes of some phenomenon of interest (Kellstedt and Whitten 2019, 22)

> **Theory:** A logically consistent set of statements that explains a phenomenon of interest (Friden, Lake, and Schultz 2022, xxix)
