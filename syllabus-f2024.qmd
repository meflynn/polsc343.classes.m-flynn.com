...
dfr$comment[dfr$date < as.Date("2024-08-21") | dfr$date>as.Date("2024-12-13")] <- NA
dfr$comment[dfr$date==as.Date("2024-09-08")] <- "Song/album choice due"
dfr$comment[dfr$date==as.Date("2024-09-22")] <- "Final song/album choice due"
dfr$comment[dfr$date==as.Date("2024-10-27")] <- "Annotated bibliography due"
dfr$comment[dfr$date==as.Date("2024-11-17")] <- "Wiki draft due"
dfr$comment[dfr$date==as.Date("2024-12-08")] <- "Final Wiki due"

# Photo blogs
dfr$comment[dfr$date==as.Date("2024-09-30")] <- "Blog post due"
dfr$comment[dfr$date==as.Date("2024-10-31")] <- "Blog post due"
dfr$comment[dfr$date==as.Date("2024-11-30")] <- "Blog post due"
