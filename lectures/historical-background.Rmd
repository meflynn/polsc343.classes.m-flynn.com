...
p1 <- ggplot(data = systemdata, aes(x = Year, y = Countries)) +
  ...
  theme_flynn(base_size = 1, base_family = "oswald") 
...
.pull-left[
```{r, fig.cap="Alexander Hamilton", fig.height=5, fig.width=3}
knitr::include_graphics("https://www.vhv.rs/dpng/d/173-1733803_hamilton-linmanuelmiranda-linnamonroll-john-lawrence-hamilton-hd-png.png")
```
]

.pull-right[
```{r, fig.cap="Thomas Jefferson", fig.height=5, fig.width=3}
knitr::include_graphics("https://toppng.com/uploads/preview/thomas-jefferson-11551056809h29zruw9by.png")
```
]
...
.pull-right[
<img src="../images/george-washington.png" style="position:relative;left:10px; top:-100px;">
]
...
.pull-right[
<img src="../images/napolean-bonaparte.png" style="position:relative;left:80px; top:-110px; width: 60%">
]
...
.pull-right[
<img src="../images/robert-livingston.jpg" style="left:50px; top:-100px; width= 50%;">
]
...
class: center, middle
<figure>
<img src="../images/WORPOL3_MAP01.02.jpg" style="width:60%;">
...
.pull-left[
<fig>
<img src="../images/henry-cabot-lodge.jpg" style="width:60%; top:80px;">
<br>
<br>
<br>
<br>
...
.pull-right[
<fig>
<img src="../images/henry-stimson-young.jpg" style="width:60%; top:80px;">
<br>
<br>
<br>
<br>
...
.pull-right[
<img src="../images/karl-donitz.jpg" style="width:60%; left:85px; top:-120px;">
]
