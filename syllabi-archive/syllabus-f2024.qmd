...
dfr$comment[dfr$date==as.Date("2024-12-04")] <- "DAG Exercise"

# Book Discussion
dfr$comment[dfr$date==as.Date("2024-10-18")] <- "Boczar Discussion"
dfr$comment[dfr$date==as.Date("2024-11-15")] <- "Helberg Discussion"
dfr$comment[dfr$date==as.Date("2024-12-06")] <- "Busby Discussion"
...
## `r advdate(mon, 10)`: The Use of Force (cont.) and Security Cooperation
...
## `r advdate(mon, 16)`: Environmental Politics and US Foreign Policy
