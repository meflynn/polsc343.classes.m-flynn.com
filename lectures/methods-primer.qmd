...
:::{.column}
```{r confounding-example, out.width="88%"}
#|echo: false
#|dpi: 300
#|width: 50%
library(dagitty)
...
:::{.column}
```{r confounding-car-2, fig.pos="center", out.width="88%"}
...
```{r base-rate-fallacy-figure, fig.pos="center", out.width="88%"}
library(gridExtra)
library(ggpp)
...
:::{.column}
```{r base-rate-fallacy-2, fig.pos="center", out.width="88%"}
...
:::{.column}
```{r collider-example-plot-1, out.width="88%", fig.pos="center", dpi=400}
#|echo: false
#|dpi: 300
#|width: 50%
...
:::{.column}
```{r collider-example-plot-2, out.width="88%", fig.pos="center", dpi=400}
#|echo: false
#|dpi: 300
#|width: 50%
...
- It also allows us to make predictions about what we sould expect to see in various scenarios
