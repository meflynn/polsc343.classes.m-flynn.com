...
theme_flynn <- function(){ 
      ...
      theme_minimal(base_size = basesize, base_family = "oswald") %+replace% 
        
        theme(plot.title = element_text(face = "bold", size = basesize*1.35, hjust = 0, margin = margin(t = 0, b = 0.3, l = 0, r = 0, unit = "cm")),
              plot.subtitle = element_text(size = basesize * 1.2, hjust = 0, margin = margin(t = 0, b = 0.3, l = 0, r = 0, unit = "cm")),
              plot.caption = element_text(face = "italic", size = basesize*0.9, hjust = 1, margin = margin(t = 0, unit = "cm")),
              strip.background = element_rect(fill = "gray80", color = "black", size = 0.15),
              ...
              legend.title = element_text(face = "bold", size = basesize * 1.1, hjust = 0, margin = margin(b = 0, unit = "cm")),
              legend.text = element_text(size = basesize, hjust = 0, margin = margin(l = -0.35, unit = "cm")))
}
...
theme_flynn_map <- function(){
  ...
  theme_void(base_size = basesize, base_family = "oswald") %+replace% 
    ...
    theme(plot.title = element_text(face = "bold", size = basesize*1.35, hjust = 0, margin = margin(t = 0, b = 0.1, l = 0, r = 0, unit = "cm")),
              plot.subtitle = element_text(size = basesize * 1.2, hjust = 0, margin = margin(t = 0, b = 0.0, l = 0, r = 0, unit = "cm")),
              plot.caption = element_text(face = "italic", size = basesize*0.9, hjust = 1, margin = margin(t = 0, unit = "cm")),
          strip.background = element_rect(fill = "gray80", color = "black"),
          strip.text = element_text(size = basesize, color = "black", face = "bold"),
...
alluvialplot <- ggplot(alluvial.data, aes(y = level, weight = level, axis1 = branch, axis2 = region, fill = branch)) +
  ...
  geom_label_repel(stat = "stratum", aes(label = ifelse(x == 1, after_stat(as.character(stratum)), NA), fill = branch, fontface = "bold"), size = basesize*.80, hjust = "left", nudge_x = -0.25, direction = "x", point.padding = 0, box.padding = 0.1, label.padding = 0.15, max.iter = Inf, show.legend = FALSE, alpha = 0.6) +
  geom_label_repel(stat = "stratum", aes(label = ifelse(x == 2, after_stat(as.character(stratum)), NA), fontface = "bold"), fill = "white", size = basesize*.80, hjust = "right", nudge_x = 0.38, direction = "y", point.padding = 0, box.padding = 0.1, label.padding = 0.15,  max.iter = Inf, min.segment.length = 0.15)+
